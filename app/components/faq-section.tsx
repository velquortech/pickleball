...
const FAQS = [
  {
    question: 'How do I play at Dink District?',
    answer:
...
export function FaqSection() {
  return (
    <section id="faq" className="mx-auto w-full max-w-3xl scroll-mt-20 px-4 py-24 sm:px-6">
      <div className="mb-10 flex flex-col gap-3 text-center">
        <p className="font-mono text-xs font-bold uppercase tracking-[0.12em] text-primary">FAQ</p>
